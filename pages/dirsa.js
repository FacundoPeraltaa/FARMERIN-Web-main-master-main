        ...
        complete: function (results) {
          ...
          results.data.map((d) => {
            ...
            if (d["CODIGO DE EVENTO (*)"] == "SE") {
              ...
              const fechaEventoString = d["FECHA DE EVENTO (xx/xx/xxxx)"];
              const fechaParts = fechaEventoString.split('/');
              const fechaEventoDate = new Date(fechaParts[2], fechaParts[1] - 1, fechaParts[0]);

              // Convertir el objeto Date a un Timestamp de Firebase
              const fechaEventoTimestamp = firebase.fechaTimeStamp(fechaEventoDate),
